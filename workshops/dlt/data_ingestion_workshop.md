...
- [Data ingestion with dlt](#data-ingestion-with-dlt)
  - [**What is data ingestion?**](#what-is-data-ingestion)
    - [**“A wild dataset Magically appears!”**](#a-wild-dataset-magically-appears)
    - [**Be the Magician! 😎**](#be-the-magician-)
    - [**Why are data pipelines so amazing?**](#why-are-data-pipelines-so-amazing)
    - [**What makes data pipelines so essential?**](#what-makes-data-pipelines-so-essential)
    - [**Why are data engineers so important in this process?**](#why-are-data-engineers-so-important-in-this-process)
    - [**What will you learn in this workshop?**](#what-will-you-learn-in-this-workshop)
  - [**Extracting data**](#extracting-data)
    - [**Working with REST APIs**](#working-with-rest-apis)
      - [**Common Challenges**](#common-challenges)
      - [**1. Rate limits**](#1-rate-limits)
      - [**2. Authentication**](#2-authentication)
      - [**3. Pagination**](#3-pagination)
      - [**4. Avoiding memory issues during extraction**](#4-avoiding-memory-issues-during-extraction)
      - [**Challenges with memory**](#challenges-with-memory)
      - [**The solution: streaming data**](#the-solution-streaming-data)
    - [**Example of extracting data: Grabbing data from an API**](#example-of-extracting-data-grabbing-data-from-an-api)
      - [**API documentation**:](#api-documentation)
    - [**Extracting data with dlt**](#extracting-data-with-dlt)
    - [**Why use dlt for extraction?**](#why-use-dlt-for-extraction)
    - [**Install dlt**](#install-dlt)
    - [**Example of extracting data with dlt**](#example-of-extracting-data-with-dlt)
  - [**Normalizing data**](#normalizing-data)
    - [**Data cleaning: more than just fixing errors**](#data-cleaning-more-than-just-fixing-errors)
      - [**Metadata tasks in data cleaning:**](#metadata-tasks-in-data-cleaning)
    - [**Why prepare data? Why not use JSON directly?**](#why-prepare-data-why-not-use-json-directly)
    - [**Normalization example**](#normalization-example)
    - [**How was this data processed?**](#how-was-this-data-processed)
    - [**Normalizing data with dlt**](#normalizing-data-with-dlt)
    - [**Example**](#example)
    - [**How dlt normalizes this data automatically**](#how-dlt-normalizes-this-data-automatically)
    - [**What happens behind the scenes?**](#what-happens-behind-the-scenes)
    - [**Why dlt makes normalization easy**](#why-dlt-makes-normalization-easy)
  - [**Loading data**](#loading-data)
    - [**How data loading happens without dlt**](#how-data-loading-happens-without-dlt)
    - [**Example: Loading data into database without dlt**](#example-loading-data-into-database-without-dlt)
    - [**How dlt handles the load step automatically**](#how-dlt-handles-the-load-step-automatically)
    - [**Why use dlt for loading?**](#why-use-dlt-for-loading)
    - [**Example: Loading data into database with dlt**](#example-loading-data-into-database-with-dlt)
    - [**Incremental Loading**](#incremental-loading)
    - [**How does incremental loading work?**](#how-does-incremental-loading-work)
    - [**Incremental loading methods in dlt**](#incremental-loading-methods-in-dlt)
      - [**1. Append (adding new records)**](#1-append-adding-new-records)
      - [**2. Merge (updating existing records)**](#2-merge-updating-existing-records)
    - [**Choosing between Append and Merge**](#choosing-between-append-and-merge)
    - [**Example: Incremental loading with dlt**](#example-incremental-loading-with-dlt)
    - [**Example: Loading data into a Data Warehouse (BigQuery)**](#example-loading-data-into-a-data-warehouse-bigquery)
    - [**Example: Loading data into a Data Lake (Parquet on Local FS or S3)**](#example-loading-data-into-a-data-lake-parquet-on-local-fs-or-s3)
      - [**Table formats: Delta tables \& Iceberg**](#table-formats-delta-tables--iceberg)
